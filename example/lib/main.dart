...
class _CameraExampleHomeState extends State<CameraExampleHome>
  ...
  TextEditingController _textFieldController = TextEditingController(
      text:
          "rtmp://rtmp.circular-test.oc3.be1.io:30100/mytv/assets_331_default?token=user:5234QHUO77YS8K:U0RP4FRHLO");
  ...
  Future _cameraTogglesRowWidget() async {
    ...
    if (cameras.isEmpty) {
      ...
      //       title: Icon(
      //         getCameraLensIcon(cameras[1].lensDirection),
      //       ),
  ...
  Future<String> startRecordingAndVideoStreaming() async {
    ...
    String myUrl = _textFieldController.text;
